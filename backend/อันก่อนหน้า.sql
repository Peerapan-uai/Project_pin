...
--
-- Host: mysql:3306
-- Generation Time: Apr 13, 2026 at 07:23 PM
...
(9, 'nemuser@gmail.com', '$2a$10$H6UDUZxtCJq0pC9iq2tSr.R3j4NkiMewat0UHtOsNIiaj4LJQhZWS', 'nemm', 'nemm', '0661234781', NULL, 'user', 500.00, 0, 0, NULL, '2026-04-08 23:17:31', '2026-04-11 13:00:34', NULL);
...
INSERT INTO `wallet_transactions` (`txn_id`, `user_id`, `amount`, `type`, `ref`, `created_at`) VALUES
(1, 6, 300.00, 'topup', 'TOPUP1775688550934215', '2026-04-08 22:49:11'),
(2, 6, 100.00, 'topup', 'TOPUP177568981316920', '2026-04-08 23:10:14'),
(3, 6, 400.00, 'topup', 'TOPUP1775689888705724', '2026-04-08 23:11:29'),
(4, 6, 500.00, 'topup', 'TOPUP1775689954040849', '2026-04-08 23:12:34'),
(5, 6, 0.54, 'deduct', 'session_1', '2026-04-08 23:52:09'),
(6, 6, 1.56, 'deduct', 'session_2', '2026-04-09 00:12:19'),
(7, 6, 6.34, 'deduct', 'session_3', '2026-04-09 00:20:29'),
(8, 6, 100.00, 'topup', 'TOPUP1775694174420467', '2026-04-09 00:22:54'),
(9, 6, 1000.00, 'topup', 'TOPUP1775694202935804', '2026-04-09 00:23:23'),
(10, 9, 500.00, 'topup', 'TOPUP1775912434508466', '2026-04-11 13:00:34');
...
--
ALTER TABLE `bookings`
  MODIFY `booking_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `charging_sessions`
  MODIFY `session_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `notifications`
  MODIFY `notification_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `wallet_transactions`
  MODIFY `txn_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
